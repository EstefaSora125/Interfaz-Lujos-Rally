...
public class JLabelImage extends JButton {
	private static final long serialVersionUID = 1L;
	private int arcW;
	private int arcH;

	public JLabelImage(int acrW, int arcH, String text, String icon, int hei, int wei, Color back, Color colFont,
			Font font) {
		super(text);
		this.arcH = arcH;
		this.arcW = acrW;
	...
	public JLabelImage(int acrW, int arcH, String icon, int hei, int wei, Color back) {
		this.arcH = arcH;
		this.arcW = acrW;
		this.scalable(icon, hei, wei);
		this.setBackground(back);
